...
var style_ProduccindePanelaToneladas_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("PROD.(Ton)");
    var labelText = "";
    size = 0;
    ...
    if (value >= 35.650000 && value <= 367.880000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 367.880000 && value <= 758.880000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 758.880000 && value <= 1791.210000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1791.210000 && value <= 5684.560000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 5684.560000 && value <= 8671.370000) {
            style = [ new ol.style.Style({
